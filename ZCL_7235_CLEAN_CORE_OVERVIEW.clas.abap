...
* Global Class tab: paste from ZCL_7235_CLEAN_CORE_OVERVIEW_global.abap
* Local Types tab:  paste from ZCL_7235_CLEAN_CORE_OVERVIEW_local.abap
*
* Summarizes the Clean Core learning journey from learning.txt:
* software scope, classic extensibility layers, clean core principles,
* migration workstreams, and SAP S/4HANA transition choices.
*
